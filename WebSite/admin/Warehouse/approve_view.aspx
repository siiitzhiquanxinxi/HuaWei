<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="approve_view.aspx.cs" Inherits="DTcms.Web.admin.Warehouse.approve_view" %>
...
<!--导航栏-->
<div class="location">
  <a href="approve_list.aspx" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="approve_list.aspx"><span>零星领料查询列表</span></a>
  <i class="arrow"></i>
  <span>零星领料申请查询</span>
</div>
...
<div class="tab-content">
  ...
  <dl>
   ...
   <dl>
    <dt>审核人</dt>
    <dd><asp:TextBox ID="txtApproveByName" runat="server" CssClass="input normal"  sucmsg=" "></asp:TextBox></dd>
  </dl>
   <dl>
    <dt>审核时间</dt>
    <dd><asp:TextBox ID="txtApproveDate" runat="server" CssClass="input normal"  sucmsg=" "></asp:TextBox></dd>
  </dl>
  </dl>
     <dl>
    <dt>审核意见</dt>
