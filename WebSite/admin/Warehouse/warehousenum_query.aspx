            ...
            <div class="toolbar">
                <div class="box-wrap">
                    ...
                    <div style="margin:0 0px">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="刀具条码" style="padding-left:10px;vertical-align:middle;"></asp:Label>
                        ...
                        <asp:Label ID="Label5" runat="server" Text="刀具等级" style="padding-left:10px;vertical-align:middle;"></asp:Label>
                        <asp:DropDownList ID="ddlToolLevel" runat="server"  CssClass="input">
                        ...
                        <asp:DropDownList ID="ddlState" runat="server"  CssClass="input">
                            ...
                            <asp:ListItem Value="4">工单锁定</asp:ListItem>
